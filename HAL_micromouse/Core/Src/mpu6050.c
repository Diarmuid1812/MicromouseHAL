...
/**
 * (c) Mikołaj Szustakiewicz
 * change I2C handler to switch to another I2C register
 * with previously initialised MPU6050
 */
void MPU6050_ChangeHandler(I2C_HandleTypeDef *hi2c)
{
	i2c = hi2c;
}
